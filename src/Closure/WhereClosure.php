...
namespace Ruhul\ExcelQuery\Closure;

use Ruhul\ExcelQuery\Closure\Conditions\ClosureInterface;
...
class WhereClosure
{
    ...
    private static function checkCondition(array $where, array $element): bool
    {
        ...
        $filterClass = "Ruhul\\ExcelQuery\\Closure\\Conditions\\" . self::getFilterClass($where['operator']);
